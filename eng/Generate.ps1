...
$projectNames = 'AppConfiguration', 'CognitiveServices.TextAnalytics', 'CognitiveSearch', 'Azure.Storage.Tables', 'Billing_Test', 'Dns_Test', 'Media_Test', 'Redis_Test', 'NetworkInterface'
