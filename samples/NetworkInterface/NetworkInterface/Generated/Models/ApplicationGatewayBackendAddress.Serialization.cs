...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayBackendAddress : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayBackendAddress DeserializeApplicationGatewayBackendAddress(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayBackendAddress result = new NetworkInterface.Models.ApplicationGatewayBackendAddress();
