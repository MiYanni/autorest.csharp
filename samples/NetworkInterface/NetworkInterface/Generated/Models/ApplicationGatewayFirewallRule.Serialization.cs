...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayFirewallRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayFirewallRule DeserializeApplicationGatewayFirewallRule(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayFirewallRule result = new NetworkInterface.Models.ApplicationGatewayFirewallRule();
