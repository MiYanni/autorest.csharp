...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayFirewallRuleSet : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayFirewallRuleSet DeserializeApplicationGatewayFirewallRuleSet(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayFirewallRuleSet result = new NetworkInterface.Models.ApplicationGatewayFirewallRuleSet();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ruleGroups"))
                        {
                            ...
                            result.RuleGroups = new List<NetworkInterface.Models.ApplicationGatewayFirewallRuleGroup>();
