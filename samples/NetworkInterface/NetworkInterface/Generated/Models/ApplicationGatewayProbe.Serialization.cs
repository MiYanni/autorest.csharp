...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayProbe : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayProbe DeserializeApplicationGatewayProbe(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayProbe result = new NetworkInterface.Models.ApplicationGatewayProbe();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("match"))
                        {
                            ...
                            result.Match = NetworkInterface.Models.ApplicationGatewayProbeHealthResponseMatch.DeserializeApplicationGatewayProbeHealthResponseMatch(property0.Value);
                            continue;
                        }
