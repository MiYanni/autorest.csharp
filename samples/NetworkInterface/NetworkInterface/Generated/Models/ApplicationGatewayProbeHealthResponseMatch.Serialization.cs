...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayProbeHealthResponseMatch : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayProbeHealthResponseMatch DeserializeApplicationGatewayProbeHealthResponseMatch(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayProbeHealthResponseMatch result = new NetworkInterface.Models.ApplicationGatewayProbeHealthResponseMatch();
