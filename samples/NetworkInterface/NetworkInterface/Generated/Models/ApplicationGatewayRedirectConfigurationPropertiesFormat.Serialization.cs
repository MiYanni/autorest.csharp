...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayRedirectConfigurationPropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayRedirectConfigurationPropertiesFormat DeserializeApplicationGatewayRedirectConfigurationPropertiesFormat(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayRedirectConfigurationPropertiesFormat result = new NetworkInterface.Models.ApplicationGatewayRedirectConfigurationPropertiesFormat();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("redirectType"))
                {
                    ...
                    result.RedirectType = new NetworkInterface.Models.ApplicationGatewayRedirectType(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("targetListener"))
                {
                    ...
                    result.TargetListener = NetworkInterface.Models.SubResource.DeserializeSubResource(property.Value);
                    continue;
                }
