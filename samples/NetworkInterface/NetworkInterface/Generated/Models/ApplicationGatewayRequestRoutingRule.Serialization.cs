...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayRequestRoutingRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayRequestRoutingRule DeserializeApplicationGatewayRequestRoutingRule(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayRequestRoutingRule result = new NetworkInterface.Models.ApplicationGatewayRequestRoutingRule();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("ruleType"))
                        {
                            ...
                            result.RuleType = new NetworkInterface.Models.ApplicationGatewayRequestRoutingRuleType(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("httpListener"))
                        {
                            ...
                            result.HttpListener = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("urlPathMap"))
                        {
                            ...
                            result.UrlPathMap = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
