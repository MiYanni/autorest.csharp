...
namespace NetworkInterface.Models
{
    ...
    public partial class ApplicationGatewayRequestRoutingRule : NetworkInterface.Models.SubResource
    {
        ...
        public NetworkInterface.Models.ApplicationGatewayRequestRoutingRuleType? RuleType { get; set; }
        ...
        public NetworkInterface.Models.SubResource HttpListener { get; set; }
        /// <summary> URL path map resource of the application gateway. </summary>
        public NetworkInterface.Models.SubResource UrlPathMap { get; set; }
