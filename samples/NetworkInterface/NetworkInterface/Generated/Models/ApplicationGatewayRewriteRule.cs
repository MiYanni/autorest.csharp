...
namespace NetworkInterface.Models
{
    ...
    public partial class ApplicationGatewayRewriteRule
    {
        ...
        public ICollection<NetworkInterface.Models.ApplicationGatewayRewriteRuleCondition> Conditions { get; set; }
        /// <summary> Set of actions to be done as part of the rewrite Rule. </summary>
        public NetworkInterface.Models.ApplicationGatewayRewriteRuleActionSet ActionSet { get; set; }
    }
}
