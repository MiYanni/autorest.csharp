...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewaySslCertificate : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewaySslCertificate DeserializeApplicationGatewaySslCertificate(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewaySslCertificate result = new NetworkInterface.Models.ApplicationGatewaySslCertificate();
