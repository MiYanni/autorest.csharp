...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewaySslPredefinedPolicy : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewaySslPredefinedPolicy DeserializeApplicationGatewaySslPredefinedPolicy(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewaySslPredefinedPolicy result = new NetworkInterface.Models.ApplicationGatewaySslPredefinedPolicy();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("minProtocolVersion"))
                        {
                            ...
                            result.MinProtocolVersion = new NetworkInterface.Models.ApplicationGatewaySslProtocol(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
