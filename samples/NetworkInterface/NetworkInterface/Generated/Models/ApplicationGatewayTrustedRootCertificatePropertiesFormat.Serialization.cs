...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayTrustedRootCertificatePropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayTrustedRootCertificatePropertiesFormat DeserializeApplicationGatewayTrustedRootCertificatePropertiesFormat(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayTrustedRootCertificatePropertiesFormat result = new NetworkInterface.Models.ApplicationGatewayTrustedRootCertificatePropertiesFormat();
