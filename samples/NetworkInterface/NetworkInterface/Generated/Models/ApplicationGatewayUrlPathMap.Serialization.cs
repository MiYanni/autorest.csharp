...
namespace NetworkInterface.Models
{
    public partial class ApplicationGatewayUrlPathMap : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationGatewayUrlPathMap DeserializeApplicationGatewayUrlPathMap(JsonElement element)
        {
            NetworkInterface.Models.ApplicationGatewayUrlPathMap result = new NetworkInterface.Models.ApplicationGatewayUrlPathMap();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("defaultBackendAddressPool"))
                        {
                            ...
                            result.DefaultBackendAddressPool = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("defaultBackendHttpSettings"))
                        {
                            ...
                            result.DefaultBackendHttpSettings = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("defaultRewriteRuleSet"))
                        {
                            ...
                            result.DefaultRewriteRuleSet = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("defaultRedirectConfiguration"))
                        {
                            ...
                            result.DefaultRedirectConfiguration = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
