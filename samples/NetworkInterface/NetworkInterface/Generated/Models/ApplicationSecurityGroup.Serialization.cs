...
namespace NetworkInterface.Models
{
    public partial class ApplicationSecurityGroup : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ApplicationSecurityGroup DeserializeApplicationSecurityGroup(JsonElement element)
        {
            NetworkInterface.Models.ApplicationSecurityGroup result = new NetworkInterface.Models.ApplicationSecurityGroup();
