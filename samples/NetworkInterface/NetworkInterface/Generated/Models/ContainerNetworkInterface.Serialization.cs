...
namespace NetworkInterface.Models
{
    public partial class ContainerNetworkInterface : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ContainerNetworkInterface DeserializeContainerNetworkInterface(JsonElement element)
        {
            NetworkInterface.Models.ContainerNetworkInterface result = new NetworkInterface.Models.ContainerNetworkInterface();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("containerNetworkInterfaceConfiguration"))
                        {
                            ...
                            result.ContainerNetworkInterfaceConfiguration = NetworkInterface.Models.ContainerNetworkInterfaceConfiguration.DeserializeContainerNetworkInterfaceConfiguration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("container"))
                        {
                            ...
                            result.Container = NetworkInterface.Models.Container.DeserializeContainer(property0.Value);
                            continue;
                        }
