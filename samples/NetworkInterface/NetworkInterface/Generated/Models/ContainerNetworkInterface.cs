...
namespace NetworkInterface.Models
{
    ...
    public partial class ContainerNetworkInterface : NetworkInterface.Models.SubResource
    {
        ...
        public NetworkInterface.Models.ContainerNetworkInterfaceConfiguration ContainerNetworkInterfaceConfiguration { get; internal set; }
        /// <summary> Reference to the container to which this container network interface is attached. </summary>
        public NetworkInterface.Models.Container Container { get; set; }
        /// <summary> Reference to the ip configuration on this container nic. </summary>
        public ICollection<NetworkInterface.Models.ContainerNetworkInterfaceIpConfiguration> IpConfigurations { get; internal set; }
