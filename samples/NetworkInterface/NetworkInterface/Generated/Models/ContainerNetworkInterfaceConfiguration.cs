...
namespace NetworkInterface.Models
{
    ...
    public partial class ContainerNetworkInterfaceConfiguration : NetworkInterface.Models.SubResource
    {
        ...
        public ICollection<NetworkInterface.Models.IPConfigurationProfile> IpConfigurations { get; set; }
        /// <summary> A list of container network interfaces created from this container network interface configuration. </summary>
        public ICollection<NetworkInterface.Models.SubResource> ContainerNetworkInterfaces { get; set; }
