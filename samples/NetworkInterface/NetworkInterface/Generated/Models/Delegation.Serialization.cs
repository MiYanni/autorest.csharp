...
namespace NetworkInterface.Models
{
    public partial class Delegation : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.Delegation DeserializeDelegation(JsonElement element)
        {
            NetworkInterface.Models.Delegation result = new NetworkInterface.Models.Delegation();
