...
namespace NetworkInterface.Models
{
    ...
    public partial class EffectiveNetworkSecurityGroup
    {
        ...
        public NetworkInterface.Models.SubResource NetworkSecurityGroup { get; set; }
        /// <summary> Associated resources. </summary>
        public NetworkInterface.Models.EffectiveNetworkSecurityGroupAssociation Association { get; set; }
        /// <summary> A collection of effective security rules. </summary>
        public ICollection<NetworkInterface.Models.EffectiveNetworkSecurityRule> EffectiveSecurityRules { get; set; }
