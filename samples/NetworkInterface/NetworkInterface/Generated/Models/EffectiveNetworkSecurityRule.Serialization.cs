...
namespace NetworkInterface.Models
{
    public partial class EffectiveNetworkSecurityRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.EffectiveNetworkSecurityRule DeserializeEffectiveNetworkSecurityRule(JsonElement element)
        {
            NetworkInterface.Models.EffectiveNetworkSecurityRule result = new NetworkInterface.Models.EffectiveNetworkSecurityRule();
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("protocol"))
                {
                    ...
                    result.Protocol = new NetworkInterface.Models.EffectiveSecurityRuleProtocol(property.Value.GetString());
                    continue;
                }
