...
namespace NetworkInterface.Models
{
    public partial class EffectiveRoute : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.EffectiveRoute DeserializeEffectiveRoute(JsonElement element)
        {
            NetworkInterface.Models.EffectiveRoute result = new NetworkInterface.Models.EffectiveRoute();
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("source"))
                {
                    ...
                    result.Source = new NetworkInterface.Models.EffectiveRouteSource(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("state"))
                {
                    ...
                    result.State = new NetworkInterface.Models.EffectiveRouteState(property.Value.GetString());
                    continue;
                }
