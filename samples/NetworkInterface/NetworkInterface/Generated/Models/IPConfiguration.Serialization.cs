...
namespace NetworkInterface.Models
{
    public partial class IPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.IPConfiguration DeserializeIPConfiguration(JsonElement element)
        {
            NetworkInterface.Models.IPConfiguration result = new NetworkInterface.Models.IPConfiguration();
