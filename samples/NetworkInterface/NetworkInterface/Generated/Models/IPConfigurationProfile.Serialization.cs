...
namespace NetworkInterface.Models
{
    public partial class IPConfigurationProfile : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.IPConfigurationProfile DeserializeIPConfigurationProfile(JsonElement element)
        {
            NetworkInterface.Models.IPConfigurationProfile result = new NetworkInterface.Models.IPConfigurationProfile();
