...
namespace NetworkInterface.Models
{
    public partial class IPConfigurationProfilePropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.IPConfigurationProfilePropertiesFormat DeserializeIPConfigurationProfilePropertiesFormat(JsonElement element)
        {
            NetworkInterface.Models.IPConfigurationProfilePropertiesFormat result = new NetworkInterface.Models.IPConfigurationProfilePropertiesFormat();
