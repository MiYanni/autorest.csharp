...
namespace NetworkInterface.Models
{
    public partial class IPConfigurationPropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.IPConfigurationPropertiesFormat DeserializeIPConfigurationPropertiesFormat(JsonElement element)
        {
            NetworkInterface.Models.IPConfigurationPropertiesFormat result = new NetworkInterface.Models.IPConfigurationPropertiesFormat();
