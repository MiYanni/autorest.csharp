...
namespace NetworkInterface.Models
{
    public partial class InboundNatPool : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.InboundNatPool DeserializeInboundNatPool(JsonElement element)
        {
            NetworkInterface.Models.InboundNatPool result = new NetworkInterface.Models.InboundNatPool();
