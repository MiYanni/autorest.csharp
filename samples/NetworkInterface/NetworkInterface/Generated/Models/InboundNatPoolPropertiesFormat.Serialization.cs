...
{
    public partial class InboundNatPoolPropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.InboundNatPoolPropertiesFormat DeserializeInboundNatPoolPropertiesFormat(JsonElement element)
        {
            NetworkInterface.Models.InboundNatPoolPropertiesFormat result = new NetworkInterface.Models.InboundNatPoolPropertiesFormat();
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    result.FrontendPortRangeStart = property.Value.GetInt32();
                    continue;
                }
                if (property.NameEquals("frontendPortRangeEnd"))
                {
                    result.FrontendPortRangeEnd = property.Value.GetInt32();
                    continue;
                }
