...
namespace NetworkInterface.Models
{
    public partial class InboundNatRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.InboundNatRule DeserializeInboundNatRule(JsonElement element)
        {
            NetworkInterface.Models.InboundNatRule result = new NetworkInterface.Models.InboundNatRule();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("backendIPConfiguration"))
                        {
                            ...
                            result.BackendIPConfiguration = NetworkInterface.Models.NetworkInterfaceIPConfiguration.DeserializeNetworkInterfaceIPConfiguration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("protocol"))
                        {
                            ...
                            result.Protocol = new NetworkInterface.Models.TransportProtocol(property0.Value.GetString());
                            continue;
                        }
