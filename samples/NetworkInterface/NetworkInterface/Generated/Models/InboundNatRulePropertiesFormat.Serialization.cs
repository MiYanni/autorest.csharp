...
namespace NetworkInterface.Models
{
    public partial class InboundNatRulePropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.InboundNatRulePropertiesFormat DeserializeInboundNatRulePropertiesFormat(JsonElement element)
        {
            NetworkInterface.Models.InboundNatRulePropertiesFormat result = new NetworkInterface.Models.InboundNatRulePropertiesFormat();
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("backendIPConfiguration"))
                {
                    ...
                    result.BackendIPConfiguration = NetworkInterface.Models.NetworkInterfaceIPConfiguration.DeserializeNetworkInterfaceIPConfiguration(property.Value);
                    continue;
                }
