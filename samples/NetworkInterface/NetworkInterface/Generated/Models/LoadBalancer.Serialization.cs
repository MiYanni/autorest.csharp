...
namespace NetworkInterface.Models
{
    public partial class LoadBalancer : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.LoadBalancer DeserializeLoadBalancer(JsonElement element)
        {
            NetworkInterface.Models.LoadBalancer result = new NetworkInterface.Models.LoadBalancer();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sku"))
                {
                    ...
                    result.Sku = NetworkInterface.Models.LoadBalancerSku.DeserializeLoadBalancerSku(property.Value);
                    continue;
                }
