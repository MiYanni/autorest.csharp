...
namespace NetworkInterface.Models
{
    ...
    public partial class LoadBalancer : NetworkInterface.Models.Resource
    {
        /// <summary> The load balancer SKU. </summary>
        public NetworkInterface.Models.LoadBalancerSku Sku { get; set; }
        /// <summary> A unique read-only string that changes whenever the resource is updated. </summary>
        public string Etag { get; internal set; }
        /// <summary> Object representing the frontend IPs to be used for the load balancer. </summary>
        public ICollection<NetworkInterface.Models.FrontendIPConfiguration> FrontendIPConfigurations { get; set; }
        /// <summary> Collection of backend address pools used by a load balancer. </summary>
        public ICollection<NetworkInterface.Models.BackendAddressPool> BackendAddressPools { get; set; }
        /// <summary> Object collection representing the load balancing rules Gets the provisioning. </summary>
        public ICollection<NetworkInterface.Models.LoadBalancingRule> LoadBalancingRules { get; set; }
        /// <summary> Collection of probe objects used in the load balancer. </summary>
        public ICollection<NetworkInterface.Models.Probe> Probes { get; set; }
        ...
        public ICollection<NetworkInterface.Models.InboundNatRule> InboundNatRules { get; set; }
        ...
        public ICollection<NetworkInterface.Models.InboundNatPool> InboundNatPools { get; set; }
        /// <summary> The outbound rules. </summary>
        public ICollection<NetworkInterface.Models.OutboundRule> OutboundRules { get; set; }
