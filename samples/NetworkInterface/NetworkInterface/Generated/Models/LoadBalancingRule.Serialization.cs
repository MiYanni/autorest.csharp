...
namespace NetworkInterface.Models
{
    public partial class LoadBalancingRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.LoadBalancingRule DeserializeLoadBalancingRule(JsonElement element)
        {
            NetworkInterface.Models.LoadBalancingRule result = new NetworkInterface.Models.LoadBalancingRule();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("loadDistribution"))
                        {
                            ...
                            result.LoadDistribution = new NetworkInterface.Models.LoadDistribution(property0.Value.GetString());
                            continue;
                        }
