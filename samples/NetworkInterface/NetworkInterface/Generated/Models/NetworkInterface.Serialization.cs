...
namespace NetworkInterface.Models
{
    public partial class NetworkInterface : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.NetworkInterface DeserializeNetworkInterface(JsonElement element)
        {
            NetworkInterface.Models.NetworkInterface result = new NetworkInterface.Models.NetworkInterface();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("virtualMachine"))
                        {
                            ...
                            result.VirtualMachine = NetworkInterface.Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("privateEndpoint"))
                        {
                            ...
                            result.PrivateEndpoint = NetworkInterface.Models.PrivateEndpoint.DeserializePrivateEndpoint(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("dnsSettings"))
                        {
                            ...
                            result.DnsSettings = NetworkInterface.Models.NetworkInterfaceDnsSettings.DeserializeNetworkInterfaceDnsSettings(property0.Value);
                            continue;
                        }
