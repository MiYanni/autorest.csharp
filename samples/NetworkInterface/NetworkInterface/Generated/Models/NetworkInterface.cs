...
namespace NetworkInterface.Models
{
    ...
    public partial class NetworkInterface : NetworkInterface.Models.Resource
    {
        /// <summary> A unique read-only string that changes whenever the resource is updated. </summary>
        public string Etag { get; internal set; }
        /// <summary> The reference to a virtual machine. </summary>
        public NetworkInterface.Models.SubResource VirtualMachine { get; internal set; }
        ...
        public ICollection<NetworkInterface.Models.NetworkInterfaceIPConfiguration> IpConfigurations { get; set; }
        /// <summary> A list of TapConfigurations of the network interface. </summary>
        public ICollection<NetworkInterface.Models.NetworkInterfaceTapConfiguration> TapConfigurations { get; internal set; }
        /// <summary> The DNS settings in network interface. </summary>
        public NetworkInterface.Models.NetworkInterfaceDnsSettings DnsSettings { get; set; }
