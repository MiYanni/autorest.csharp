...
namespace NetworkInterface.Models
{
    public partial class NetworkInterfaceDnsSettings : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.NetworkInterfaceDnsSettings DeserializeNetworkInterfaceDnsSettings(JsonElement element)
        {
            NetworkInterface.Models.NetworkInterfaceDnsSettings result = new NetworkInterface.Models.NetworkInterfaceDnsSettings();
