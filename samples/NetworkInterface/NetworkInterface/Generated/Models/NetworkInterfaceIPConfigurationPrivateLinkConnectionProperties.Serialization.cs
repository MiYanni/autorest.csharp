...
namespace NetworkInterface.Models
{
    public partial class NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties DeserializeNetworkInterfaceIPConfigurationPrivateLinkConnectionProperties(JsonElement element)
        {
            NetworkInterface.Models.NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties result = new NetworkInterface.Models.NetworkInterfaceIPConfigurationPrivateLinkConnectionProperties();
