...
namespace NetworkInterface.Models
{
    public partial class NetworkProfile : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.NetworkProfile DeserializeNetworkProfile(JsonElement element)
        {
            NetworkInterface.Models.NetworkProfile result = new NetworkInterface.Models.NetworkProfile();
