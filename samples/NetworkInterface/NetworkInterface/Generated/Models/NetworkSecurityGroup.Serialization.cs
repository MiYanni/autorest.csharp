...
namespace NetworkInterface.Models
{
    public partial class NetworkSecurityGroup : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.NetworkSecurityGroup DeserializeNetworkSecurityGroup(JsonElement element)
        {
            NetworkInterface.Models.NetworkSecurityGroup result = new NetworkInterface.Models.NetworkSecurityGroup();
