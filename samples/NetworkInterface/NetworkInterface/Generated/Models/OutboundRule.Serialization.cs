...
namespace NetworkInterface.Models
{
    public partial class OutboundRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.OutboundRule DeserializeOutboundRule(JsonElement element)
        {
            NetworkInterface.Models.OutboundRule result = new NetworkInterface.Models.OutboundRule();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("frontendIPConfigurations"))
                        {
                            ...
                            result.FrontendIPConfigurations = new List<NetworkInterface.Models.SubResource>();
                        ...
                        if (property0.NameEquals("protocol"))
                        {
                            ...
                            result.Protocol = new NetworkInterface.Models.LoadBalancerOutboundRuleProtocol(property0.Value.GetString());
                            continue;
                        }
