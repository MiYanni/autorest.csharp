...
namespace NetworkInterface.Models
{
    public partial class PrivateEndpoint : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.PrivateEndpoint DeserializePrivateEndpoint(JsonElement element)
        {
            NetworkInterface.Models.PrivateEndpoint result = new NetworkInterface.Models.PrivateEndpoint();
