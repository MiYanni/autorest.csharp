...
namespace NetworkInterface.Models
{
    public partial class PrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.PrivateEndpointConnection DeserializePrivateEndpointConnection(JsonElement element)
        {
            NetworkInterface.Models.PrivateEndpointConnection result = new NetworkInterface.Models.PrivateEndpointConnection();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateLinkServiceConnectionState"))
                        {
                            ...
                            result.PrivateLinkServiceConnectionState = NetworkInterface.Models.PrivateLinkServiceConnectionState.DeserializePrivateLinkServiceConnectionState(property0.Value);
                            continue;
                        }
