...
namespace NetworkInterface.Models
{
    public partial class PrivateLinkServiceConnectionState : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.PrivateLinkServiceConnectionState DeserializePrivateLinkServiceConnectionState(JsonElement element)
        {
            NetworkInterface.Models.PrivateLinkServiceConnectionState result = new NetworkInterface.Models.PrivateLinkServiceConnectionState();
