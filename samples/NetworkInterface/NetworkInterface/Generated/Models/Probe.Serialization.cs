...
namespace NetworkInterface.Models
{
    public partial class Probe : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.Probe DeserializeProbe(JsonElement element)
        {
            NetworkInterface.Models.Probe result = new NetworkInterface.Models.Probe();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("protocol"))
                        {
                            ...
                            result.Protocol = new NetworkInterface.Models.ProbeProtocol(property0.Value.GetString());
                            continue;
                        }
