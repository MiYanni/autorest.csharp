...
namespace NetworkInterface.Models
{
    public partial class PublicIPAddress : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.PublicIPAddress DeserializePublicIPAddress(JsonElement element)
        {
            NetworkInterface.Models.PublicIPAddress result = new NetworkInterface.Models.PublicIPAddress();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sku"))
                {
                    ...
                    result.Sku = NetworkInterface.Models.PublicIPAddressSku.DeserializePublicIPAddressSku(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("publicIPAllocationMethod"))
                        {
                            ...
                            result.PublicIPAllocationMethod = new NetworkInterface.Models.IPAllocationMethod(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("publicIPAddressVersion"))
                        {
                            ...
                            result.PublicIPAddressVersion = new NetworkInterface.Models.IPVersion(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("ipConfiguration"))
                        {
                            ...
                            result.IpConfiguration = NetworkInterface.Models.IPConfiguration.DeserializeIPConfiguration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("dnsSettings"))
                        {
                            ...
                            result.DnsSettings = NetworkInterface.Models.PublicIPAddressDnsSettings.DeserializePublicIPAddressDnsSettings(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("ddosSettings"))
                        {
                            ...
                            result.DdosSettings = NetworkInterface.Models.DdosSettings.DeserializeDdosSettings(property0.Value);
                            continue;
                        }
