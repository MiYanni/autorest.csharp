...
namespace NetworkInterface.Models
{
    public partial class PublicIPAddressDnsSettings : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.PublicIPAddressDnsSettings DeserializePublicIPAddressDnsSettings(JsonElement element)
        {
            NetworkInterface.Models.PublicIPAddressDnsSettings result = new NetworkInterface.Models.PublicIPAddressDnsSettings();
