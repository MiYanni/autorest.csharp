...
namespace NetworkInterface.Models
{
    public partial class Resource : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.Resource DeserializeResource(JsonElement element)
        {
            NetworkInterface.Models.Resource result = new NetworkInterface.Models.Resource();
