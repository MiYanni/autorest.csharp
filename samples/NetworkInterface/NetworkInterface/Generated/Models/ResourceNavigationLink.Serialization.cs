...
namespace NetworkInterface.Models
{
    public partial class ResourceNavigationLink : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ResourceNavigationLink DeserializeResourceNavigationLink(JsonElement element)
        {
            NetworkInterface.Models.ResourceNavigationLink result = new NetworkInterface.Models.ResourceNavigationLink();
