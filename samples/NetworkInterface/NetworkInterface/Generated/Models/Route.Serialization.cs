...
namespace NetworkInterface.Models
{
    public partial class Route : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.Route DeserializeRoute(JsonElement element)
        {
            NetworkInterface.Models.Route result = new NetworkInterface.Models.Route();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("nextHopType"))
                        {
                            ...
                            result.NextHopType = new NetworkInterface.Models.RouteNextHopType(property0.Value.GetString());
                            continue;
                        }
