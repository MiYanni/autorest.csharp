...
namespace NetworkInterface.Models
{
    public partial class SecurityRule : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.SecurityRule DeserializeSecurityRule(JsonElement element)
        {
            NetworkInterface.Models.SecurityRule result = new NetworkInterface.Models.SecurityRule();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("protocol"))
                        {
                            ...
                            result.Protocol = new NetworkInterface.Models.SecurityRuleProtocol(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("access"))
                        {
                            ...
                            result.Access = new NetworkInterface.Models.SecurityRuleAccess(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("direction"))
                        {
                            ...
                            result.Direction = new NetworkInterface.Models.SecurityRuleDirection(property0.Value.GetString());
                            continue;
                        }
