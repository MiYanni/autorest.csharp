...
namespace NetworkInterface.Models
{
    public partial class ServiceAssociationLink : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ServiceAssociationLink DeserializeServiceAssociationLink(JsonElement element)
        {
            NetworkInterface.Models.ServiceAssociationLink result = new NetworkInterface.Models.ServiceAssociationLink();
