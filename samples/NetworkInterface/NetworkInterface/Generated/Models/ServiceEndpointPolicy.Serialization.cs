...
namespace NetworkInterface.Models
{
    public partial class ServiceEndpointPolicy : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.ServiceEndpointPolicy DeserializeServiceEndpointPolicy(JsonElement element)
        {
            NetworkInterface.Models.ServiceEndpointPolicy result = new NetworkInterface.Models.ServiceEndpointPolicy();
