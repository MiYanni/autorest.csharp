...
namespace NetworkInterface.Models
{
    ...
    public partial class Subnet : NetworkInterface.Models.SubResource
    {
        ...
        public NetworkInterface.Models.NetworkSecurityGroup NetworkSecurityGroup { get; set; }
        /// <summary> The reference to the RouteTable resource. </summary>
        public NetworkInterface.Models.RouteTable RouteTable { get; set; }
        /// <summary> Nat gateway associated with this subnet. </summary>
        public NetworkInterface.Models.SubResource NatGateway { get; set; }
        /// <summary> An array of service endpoints. </summary>
        public ICollection<NetworkInterface.Models.ServiceEndpointPropertiesFormat> ServiceEndpoints { get; set; }
        /// <summary> An array of service endpoint policies. </summary>
        public ICollection<NetworkInterface.Models.ServiceEndpointPolicy> ServiceEndpointPolicies { get; set; }
        /// <summary> An array of references to private endpoints. </summary>
        public ICollection<NetworkInterface.Models.PrivateEndpoint> PrivateEndpoints { get; internal set; }
        /// <summary> An array of references to the network interface IP configurations using subnet. </summary>
        public ICollection<NetworkInterface.Models.IPConfiguration> IpConfigurations { get; internal set; }
        /// <summary> Array of IP configuration profiles which reference this subnet. </summary>
        public ICollection<NetworkInterface.Models.IPConfigurationProfile> IpConfigurationProfiles { get; internal set; }
        /// <summary> An array of references to the external resources using subnet. </summary>
        public ICollection<NetworkInterface.Models.ResourceNavigationLink> ResourceNavigationLinks { get; internal set; }
        /// <summary> An array of references to services injecting into this subnet. </summary>
        public ICollection<NetworkInterface.Models.ServiceAssociationLink> ServiceAssociationLinks { get; internal set; }
        /// <summary> An array of references to the delegations on the subnet. </summary>
        public ICollection<NetworkInterface.Models.Delegation> Delegations { get; set; }
