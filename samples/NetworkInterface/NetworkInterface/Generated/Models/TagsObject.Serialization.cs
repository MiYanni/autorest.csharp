...
namespace NetworkInterface.Models
{
    public partial class TagsObject : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.TagsObject DeserializeTagsObject(JsonElement element)
        {
            NetworkInterface.Models.TagsObject result = new NetworkInterface.Models.TagsObject();
