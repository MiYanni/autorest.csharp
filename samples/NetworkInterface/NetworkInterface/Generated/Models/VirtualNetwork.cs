...
namespace NetworkInterface.Models
{
    ...
    public partial class VirtualNetwork : NetworkInterface.Models.Resource
    {
        ...
        public NetworkInterface.Models.AddressSpace AddressSpace { get; set; }
        /// <summary> The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network. </summary>
        public NetworkInterface.Models.DhcpOptions DhcpOptions { get; set; }
        /// <summary> A list of subnets in a Virtual Network. </summary>
        public ICollection<NetworkInterface.Models.Subnet> Subnets { get; set; }
        /// <summary> A list of peerings in a Virtual Network. </summary>
        public ICollection<NetworkInterface.Models.VirtualNetworkPeering> VirtualNetworkPeerings { get; set; }
        ...
        public NetworkInterface.Models.SubResource DdosProtectionPlan { get; set; }
        /// <summary> Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET. </summary>
        public NetworkInterface.Models.VirtualNetworkBgpCommunities BgpCommunities { get; set; }
    }
}
