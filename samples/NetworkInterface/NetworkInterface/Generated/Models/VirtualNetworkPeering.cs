...
namespace NetworkInterface.Models
{
    ...
    public partial class VirtualNetworkPeering : NetworkInterface.Models.SubResource
    {
        ...
        public NetworkInterface.Models.SubResource RemoteVirtualNetwork { get; set; }
        /// <summary> The reference to the remote virtual network address space. </summary>
        public NetworkInterface.Models.AddressSpace RemoteAddressSpace { get; set; }
        /// <summary> The status of the virtual network peering. </summary>
        public NetworkInterface.Models.VirtualNetworkPeeringState? PeeringState { get; set; }
