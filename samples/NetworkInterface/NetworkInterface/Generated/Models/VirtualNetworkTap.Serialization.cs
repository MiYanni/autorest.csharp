...
namespace NetworkInterface.Models
{
    public partial class VirtualNetworkTap : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface.Models.VirtualNetworkTap DeserializeVirtualNetworkTap(JsonElement element)
        {
            NetworkInterface.Models.VirtualNetworkTap result = new NetworkInterface.Models.VirtualNetworkTap();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("destinationNetworkInterfaceIPConfiguration"))
                        {
                            ...
                            result.DestinationNetworkInterfaceIPConfiguration = NetworkInterface.Models.NetworkInterfaceIPConfiguration.DeserializeNetworkInterfaceIPConfiguration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("destinationLoadBalancerFrontEndIPConfiguration"))
                        {
                            ...
                            result.DestinationLoadBalancerFrontEndIPConfiguration = NetworkInterface.Models.FrontendIPConfiguration.DeserializeFrontendIPConfiguration(property0.Value);
                            continue;
                        }
